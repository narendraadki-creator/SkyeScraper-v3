-- Migration 031: Three-Role System Phase 1 - Preparation (FIXED)
...
INSERT INTO activity_logs (
    ...
    'system',
    NULL,
    ('{"migration": "031_three_role_system_phase1", "phase": "preparation", "timestamp": "' || NOW() || '"}')::jsonb,
    NOW()
);

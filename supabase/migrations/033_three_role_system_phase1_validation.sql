-- Migration 033: Three-Role System Phase 1 - Validation and Testing
...
-- Step 6: Show detailed mapping for review
SELECT 'ROLE MAPPING DETAILS:' as info;
